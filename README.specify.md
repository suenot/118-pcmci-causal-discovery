...
PCMCI алгоритм для обнаружения причинных связей во временных рядах.
...
1. **Detecting and Quantifying Causal Associations in Large Nonlinear Time Series Datasets**
